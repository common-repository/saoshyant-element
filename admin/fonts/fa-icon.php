...
*/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
 if ( !function_exists ( "sor_fa_icon" )){

function sor_fa_icon( $element) {

$sor_icons =array(
	
	__('آیکون های برنامه وب','sorsorak')=> array(
	...
	__('آیکون دسترسی','sorsorak')=> array(
	...
	__('آیکون های حمل و نقل','sorsorak')=> array(
	...
	__('آیکون های جنسیت','sorsorak')=> array(
	...
	__('آیکون های نوع فایل','sorsorak')=> array(
		'fa-file' => 'file',
		'fa-file-archive-o' => 'file-archive-o',
		'fa-file-audio-o' => 'file-audio-o',
		'fa-file-code-o' => 'file-code-o',
	...
	__('آیکون های اسپینر','sorsorak')=> array(
		'fa-circle-o-notch' => 'circle-o-notch',
		'fa-cog' => 'cog',
		'fa-gear' => 'gear',
		'fa-refresh' => 'refresh',
	...
	__('آیکون های کنترل فرم','sorsorak')=> array(
		'fa-check-square' => 'check-square',
		'fa-check-square-o' => 'check-square-o',
		'fa-circle' => 'circle',
		'fa-circle-o' => 'circle-o',
	...
	__('آیکون های پرداخت','sorsorak')=> array(
		'fa-cc-amex' => 'cc-amex',
	...
	__('آیکون های نمودار','sorsorak')=> array(
		'fa-area-chart' => 'area-chart',
		'fa-bar-chart' => 'bar-chart',
		'fa-bar-chart-o' => 'bar-chart-o',
		'fa-line-chart' => 'line-chart',
	...
	__('آیکون های ارز','sorsorak')=> array(
		'fa-bitcoin' => 'bitcoin',
		'fa-btc' => 'btc',
		'fa-cny' => 'cny',
		'fa-dollar' => 'dollar',
	...
	__('آیکون های ویرایشگر متن','sorsorak')=> array(
	...
	__('آیکون های جهت دار','sorsorak')=> array(
	...
	__('آیکون های پخش کننده ویدیو','sorsorak')=> array(
		'fa-arrows-alt' => 'arrows-alt',
	...
	__('نمادهای نام تجاری','sorsorak')=> array(
		'fa-500px' => '500px',
		'fa-adn' => 'adn',
		'fa-amazon' => 'amazon',
		'fa-android' => 'android',
	...
	__('آیکون های پزشکی','sorsorak')=> array(
		'fa-ambulance' => 'ambulance',
	...
	$element['FontAwesome']=$sor_icons;
    return $element;
}
add_filter('sor_icon_element', 'sor_fa_icon');
 }
?>